...
class Query {
    ...
    static Params(req, initReq) {
        return fm.fetchReq(`/compute/v1beta1/params?${fm.renderURLSearchParams(req, [])}`, Object.assign(Object.assign({}, initReq), { method: "GET" }));
    }
    static AuthorizedMigration(req, initReq) {
        return fm.fetchReq(`/compute/v1beta1/authorized_migration/${req["contract_address"]}?${fm.renderURLSearchParams(req, ["contract_address"])}`, Object.assign(Object.assign({}, initReq), { method: "GET" }));
    }
}
exports.Query = Query;
