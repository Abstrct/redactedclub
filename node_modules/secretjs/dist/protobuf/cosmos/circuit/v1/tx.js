...
exports.MsgAuthorizeCircuitBreaker = {
    ...
    create(base) {
        return exports.MsgAuthorizeCircuitBreaker.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseMsgAuthorizeCircuitBreaker();
...
exports.MsgAuthorizeCircuitBreakerResponse = {
    ...
    create(base) {
        return exports.MsgAuthorizeCircuitBreakerResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseMsgAuthorizeCircuitBreakerResponse();
...
exports.MsgTripCircuitBreaker = {
    ...
    create(base) {
        return exports.MsgTripCircuitBreaker.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseMsgTripCircuitBreaker();
        message.authority = (_a = object.authority) !== null && _a !== void 0 ? _a : "";
        message.msg_type_urls = ((_b = object.msg_type_urls) === null || _b === void 0 ? void 0 : _b.map((e) => e)) || [];
        return message;
    },
};
...
exports.MsgTripCircuitBreakerResponse = {
    ...
    create(base) {
        return exports.MsgTripCircuitBreakerResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseMsgTripCircuitBreakerResponse();
...
exports.MsgResetCircuitBreaker = {
    ...
    create(base) {
        return exports.MsgResetCircuitBreaker.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseMsgResetCircuitBreaker();
...
exports.MsgResetCircuitBreakerResponse = {
    ...
    create(base) {
        return exports.MsgResetCircuitBreakerResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseMsgResetCircuitBreakerResponse();
...
class MsgClientImpl {
    ...
    AuthorizeCircuitBreaker(request) {
        ...
        return promise.then((data) => exports.MsgAuthorizeCircuitBreakerResponse.decode(_m0.Reader.create(data)));
    }
    TripCircuitBreaker(request) {
        ...
        return promise.then((data) => exports.MsgTripCircuitBreakerResponse.decode(_m0.Reader.create(data)));
    }
    ResetCircuitBreaker(request) {
        ...
        return promise.then((data) => exports.MsgResetCircuitBreakerResponse.decode(_m0.Reader.create(data)));
    }
}
