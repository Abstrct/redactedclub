...
exports.MsgInstantiateContract = {
    ...
    fromJSON(object) {
        return {
            ...
            init_funds: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.init_funds)
...
exports.MsgExecuteContract = {
    ...
    fromJSON(object) {
        return {
            ...
            callback_code_hash: isSet(object.callback_code_hash) ? globalThis.String(object.callback_code_hash) : "",
            sent_funds: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.sent_funds)
...
function createBaseMsgUpgradeProposalPassed() {
...
exports.MsgUpgradeProposalPassed = {
    ...
    create(base) {
        return exports.MsgUpgradeProposalPassed.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseMsgUpgradeProposalPassed();
        message.sender_address = (_a = object.sender_address) !== null && _a !== void 0 ? _a : "";
        message.mr_enclave_hash = (_b = object.mr_enclave_hash) !== null && _b !== void 0 ? _b : new Uint8Array(0);
        return message;
    },
};
function createBaseMsgUpgradeProposalPassedResponse() {
    return {};
}
exports.MsgUpgradeProposalPassedResponse = {
    encode(_, writer = _m0.Writer.create()) {
    ...
    create(base) {
        return exports.MsgUpgradeProposalPassedResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseMsgUpgradeProposalPassedResponse();
        return message;
...
function createBaseMigrateContractInfo() {
    return { address: "", new_code_id: "0" };
}
exports.MigrateContractInfo = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.address !== "") {
            writer.uint32(10).string(message.address);
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.new_code_id = longToString(reader.uint64());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    create(base) {
        return exports.MigrateContractInfo.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseMigrateContractInfo();
        message.address = (_a = object.address) !== null && _a !== void 0 ? _a : "";
        message.new_code_id = (_b = object.new_code_id) !== null && _b !== void 0 ? _b : "0";
        return message;
    },
};
function createBaseMsgMigrateContractProposal() {
    return { authority: "", title: "", description: "", contracts: [] };
}
exports.MsgMigrateContractProposal = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.authority !== "") {
            writer.uint32(10).string(message.authority);
        }
        ...
        for (const v of message.contracts) {
            exports.MigrateContractInfo.encode(v, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    message.contracts.push(exports.MigrateContractInfo.decode(reader, reader.uint32()));
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            contracts: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.contracts)
                ? object.contracts.map((e) => exports.MigrateContractInfo.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if ((_a = message.contracts) === null || _a === void 0 ? void 0 : _a.length) {
            obj.contracts = message.contracts.map((e) => exports.MigrateContractInfo.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.MsgMigrateContractProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseMsgMigrateContractProposal();
        ...
        message.contracts = ((_d = object.contracts) === null || _d === void 0 ? void 0 : _d.map((e) => exports.MigrateContractInfo.fromPartial(e))) || [];
        return message;
    },
};
function createBaseMsgMigrateContractProposalResponse() {
    return {};
}
exports.MsgMigrateContractProposalResponse = {
    encode(_, writer = _m0.Writer.create()) {
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.MsgMigrateContractProposalResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseMsgMigrateContractProposalResponse();
        return message;
...
function createBaseMsgSetContractGovernance() {
    return { sender: "", contract_address: "" };
}
exports.MsgSetContractGovernance = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.sender !== "") {
            writer.uint32(10).string(message.sender);
        }
    ...
    create(base) {
        return exports.MsgSetContractGovernance.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseMsgSetContractGovernance();
        message.sender = (_a = object.sender) !== null && _a !== void 0 ? _a : "";
        message.contract_address = (_b = object.contract_address) !== null && _b !== void 0 ? _b : "";
        return message;
    },
};
function createBaseMsgSetContractGovernanceResponse() {
    return {};
}
exports.MsgSetContractGovernanceResponse = {
    encode(_, writer = _m0.Writer.create()) {
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.MsgSetContractGovernanceResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseMsgSetContractGovernanceResponse();
        return message;
...
class MsgClientImpl {
    ...
    UpgradeProposalPassed(request) {
        const data = exports.MsgUpgradeProposalPassed.encode(request).finish();
        const promise = this.rpc.request(this.service, "UpgradeProposalPassed", data);
        return promise.then((data) => exports.MsgUpgradeProposalPassedResponse.decode(_m0.Reader.create(data)));
    }
    MigrateContractProposal(request) {
        const data = exports.MsgMigrateContractProposal.encode(request).finish();
        const promise = this.rpc.request(this.service, "MigrateContractProposal", data);
        return promise.then((data) => exports.MsgMigrateContractProposalResponse.decode(_m0.Reader.create(data)));
    }
    SetContractGovernance(request) {
        const data = exports.MsgSetContractGovernance.encode(request).finish();
        const promise = this.rpc.request(this.service, "SetContractGovernance", data);
        return promise.then((data) => exports.MsgSetContractGovernanceResponse.decode(_m0.Reader.create(data)));
    }
}
