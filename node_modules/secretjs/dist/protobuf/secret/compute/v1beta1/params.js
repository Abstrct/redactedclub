...
exports.Params = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.max_contract_size = longToString(reader.uint64());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromPartial(object) {
        var _a, _b;
        const message = createBaseParams();
        message.compile_cost = (_a = object.compile_cost) !== null && _a !== void 0 ? _a : "";
        message.max_contract_size = (_b = object.max_contract_size) !== null && _b !== void 0 ? _b : "0";
        return message;
    },
};
