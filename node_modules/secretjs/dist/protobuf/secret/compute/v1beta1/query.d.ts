...
export declare const ParamsResponse: {
    ...
    create(base?: {
        params?: {
            compile_cost?: string | undefined;
            max_contract_size?: string | undefined;
        } | undefined;
...
export declare const QueryContractInfoResponse: {
    ...
    create(base?: {
        ...
        contract_info?: {
            ...
            require_governance?: boolean | undefined;
        } | undefined;
...
export declare const QueryAuthorizedMigrationRequest: {
    encode(message: QueryAuthorizedMigrationRequest, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): QueryAuthorizedMigrationRequest;
    fromJSON(object: any): QueryAuthorizedMigrationRequest;
    toJSON(message: QueryAuthorizedMigrationRequest): unknown;
    create(base?: {
        contract_address?: string | undefined;
    } | undefined): QueryAuthorizedMigrationRequest;
    fromPartial(object: DeepPartial<QueryAuthorizedMigrationRequest>): QueryAuthorizedMigrationRequest;
};
export declare const QueryAuthorizedMigrationResponse: {
    encode(message: QueryAuthorizedMigrationResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): QueryAuthorizedMigrationResponse;
    fromJSON(object: any): QueryAuthorizedMigrationResponse;
    toJSON(message: QueryAuthorizedMigrationResponse): unknown;
    create(base?: {
        new_code_id?: string | undefined;
    } | undefined): QueryAuthorizedMigrationResponse;
