...
exports.QueryClientImpl = exports.QueryServiceName = exports.QueryAuthorizedMigrationResponse = exports.QueryAuthorizedMigrationRequest = exports.QueryContractHistoryResponse = exports.QueryContractHistoryRequest = exports.DecryptedAnswers = exports.DecryptedAnswer = exports.QueryCodeHashResponse = exports.QueryContractLabelResponse = exports.QueryContractAddressResponse = exports.QueryCodesResponse = exports.QueryCodeResponse = exports.CodeInfoResponse = exports.QueryContractsByCodeIdResponse = exports.ContractInfoWithAddress = exports.QueryContractInfoResponse = exports.QuerySecretContractResponse = exports.QueryByCodeIdRequest = exports.QueryByContractAddressRequest = exports.QueryByLabelRequest = exports.QuerySecretContractRequest = exports.ParamsResponse = exports.ParamsRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
function createBaseQueryAuthorizedMigrationRequest() {
    return { contract_address: "" };
}
exports.QueryAuthorizedMigrationRequest = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.contract_address !== "") {
            writer.uint32(10).string(message.contract_address);
        }
    ...
    create(base) {
        return exports.QueryAuthorizedMigrationRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryAuthorizedMigrationRequest();
...
function createBaseQueryAuthorizedMigrationResponse() {
    return { new_code_id: "0" };
}
exports.QueryAuthorizedMigrationResponse = {
    encode(message, writer = _m0.Writer.create()) {
    ...
    create(base) {
        return exports.QueryAuthorizedMigrationResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryAuthorizedMigrationResponse();
        message.new_code_id = (_a = object.new_code_id) !== null && _a !== void 0 ? _a : "0";
        return message;
    },
};
...
class QueryClientImpl {
    ...
    AuthorizedMigration(request) {
        const data = exports.QueryAuthorizedMigrationRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "AuthorizedMigration", data);
        return promise.then((data) => exports.QueryAuthorizedMigrationResponse.decode(_m0.Reader.create(data)));
    }
}
